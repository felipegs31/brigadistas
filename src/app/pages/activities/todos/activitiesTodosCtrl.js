...
(function () {
  ...
  angular.module('BlurAdmin.pages.activities')
      .controller('activitiesTodosCtrl',['$scope', '$filter','editableOptions','editableThemes', 'activitiesFactory','$stateParams', '$state',
        function($scope,$filter,editableOptions,editableThemes,activitiesFactory,$stateParams,$state){ 
    ...
    $scope.mostraDelecao = function(){
      ...
      $scope.removeActivities = function(item){
         activitiesFactory.delete({id: item})
         .$promise.then(
            function (response) {
              $state.reload();
            }
